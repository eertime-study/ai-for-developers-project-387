...
> Стартовое состояние: значения ещё не зафиксированы. Первый прогон агента заполнит таблицы и
> зафиксирует стартовый базлайн (сравнивать будет не с чем — это нормально).
