...
> Последний прогон: **2026-06-13 (UTC)**. Регрессий категорий нет; помечена одна lab-регрессия >10%
> — Speed Index админки (596 → 731 ms, +22.7%), детали в issue `[lighthouse]`. Следующий прогон
> сравнивается с самой нижней строкой каждой таблицы.
